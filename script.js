...
const translations = {
    fr: {
        ...
        "alternance.semestre7": "Semestre 7",
        "alternance.uf71.title": "UF 7.1 VIE PROFESSIONNELLE : Maîtrise de Projet",
        "alternance.status.validated": "Validé",
        "alternance.status.pending": "En cours de validation",
        "alternance.obj.expected": "Objectifs attendus :",
        "alternance.realizations": "Mes réalisations en entreprise :",
        "alternance.uf71.obj1": "Organisation, gestion du travail sur un ou plusieurs projets",
        ...
        "alternance.uf73.obj.ips.1": "Mise en application des concepts de programmation web front & back",
        ...
        "alternance.uf81.obj1": "Normes et certification, démarche qualité, prise en compte des aspects réglementaires",
    ...
    en: {
        ...
        "alternance.semestre7": "Semester 7",
        "alternance.uf71.title": "UF 7.1 PROFESSIONAL LIFE: Project Management",
        "alternance.status.validated": "Validated",
        "alternance.status.pending": "Pending validation",
        "alternance.obj.expected": "Expected objectives:",
        "alternance.realizations": "My realizations in the company:",
        "alternance.uf71.obj1": "Organization, work management on one or more projects",
        ...
        "alternance.uf71.template": "As part of my apprenticeship at COVEA, I autonomously organize automated test campaigns. Regarding the security of vital and fundamental business services, I define business objectives and non-regression tests. I identify all existing tests and design new ones to cover business needs. This project is a central theme throughout my training. During this semester, the initial focus was on doing this work for the MMA brand to get accustomed to the company's tools and processes.",
        ...
        "alternance.uf72.template": "I design and maintain automated test scripts (Selenium, UFT/VBScript) and data population scripts. I use automation tools (Jenkins, Selenium, Squash) on a daily basis and fluently handle various data formats (JSON, XML) to secure the vital services of the information system.",
        ...
        "alternance.uf73.obj.ips.1": "Application of front & back web programming concepts",
        ...
        "alternance.uf73.template": "To write/fix automated tests, I apply standard web programming knowledge, principles and logic (OOP, Page Object Model, versioning).",

        "alternance.semestre8": "Semester 8",
        "alternance.uf81.title": "UF 8.1 PROFESSIONAL LIFE: Project conduct",
        "alternance.uf81.obj1": "Standards and certification, quality approach, consideration of regulatory aspects",
        "alternance.uf81.obj2": "Search for solutions in design / implementation / product / service",
        "alternance.uf81.obj3": "Mission organization, team leadership and exercise of responsibilities",
        "alternance.uf81.obj4": "Presentation of deliverables, assessment of actions and commitment to corrective actions",
        "alternance.uf81.template": "Continuation of work on vital and fundamental business services at COVEA. The project, on the MMA side, is at the stage of finalizing the validation of the retrieved tests. This project is now extended to the GMF and MAAF brands.",

        "alternance.uf82.title": "UF 8.2 TECHNICAL: Information System Security",
        "alternance.uf82.obj1": "Identify the risks of a cyberattack",
        "alternance.uf82.obj2": "Understand how the Web works in a complex information system",
        "alternance.uf82.obj3": "Know the flaws in a system and the security devices",
        "alternance.uf82.obj4": "Propose a security policy for an information system",
        "alternance.uf82.template": "To strengthen the company's security, we noticed that connection data to test accounts were exposed in the Git history via .env files. I therefore participated in moving these variables to a secure variable server.",

        "alternance.uf83.title": "UF 8.3 TECHNICAL: Ergonomics Project (IPS) / GPU DSP or ARM App (ASTRE)",
        "alternance.uf83.obj.ips": "Expected objectives (IPS / Ergonomics):",
        "alternance.uf83.obj.ips.1": "Application of knowledge seen in interface design on screen organization",
        "alternance.uf83.obj.astre": "Expected objectives (ASTRE / Microprocessor):",
        "alternance.uf83.obj.astre.1": "Application of knowledge in microprocessor programming (GPU, DSP, ARM...)",
        "alternance.uf83.template": "This skill will be validated during a training session dedicated to interface ergonomics.",
